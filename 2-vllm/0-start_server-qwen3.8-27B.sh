...
###
 # @Author: AI产品研发组
 # @Date: 2026-08-17
 # @Description: vLLM OpenAI 兼容 API 服务启动脚本 — Qwen3.8-27B (dense，多模态)
###

#-----------------#
# ⭐需要修改的值⭐
#-----------------#
gpu_ids="0,1"                                          # 27B dense BF16 约 54GB，双卡 48GB 即可
#----------------------------------------------------#
weight='/home/ubuntu/models/Qwen3.8-27B'               # 模型权重路径
#----------------------------------------------------#
port=8081                                              # 服务端口（避免与 35B-A3B 的 8081 冲突）
#----------------------------------------------------#
model_name="qwen3.8-27b"                               # 对外暴露的模型名
#----------------------------------------------------#
max_model_len=131072                                    # 27B dense KV 较大，双卡 48GB 建议 16k~32k
#----------------------------------------------------#
gpu_memory_utilization=0.85                            # dense 全量激活，可按需下调
#----------------------------------------------------#
