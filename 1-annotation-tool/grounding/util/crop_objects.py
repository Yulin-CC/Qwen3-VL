...
# @Command: python util/crop_objects.py --dataset /path/to/data
"""
...
def crop_dataset(dataset_root, expand_ratio=1.5, draw_box=True, limit=None,
    ...
    """
    from common import detect_geometry, geometry_for_jsons_dirname
...
def parse_args():
    ...
    p.add_argument("--jsons", default="jsons", help="jsons|jsons-detect|jsons-segm|绝对路径")
